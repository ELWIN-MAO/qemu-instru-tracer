...
#/usr/local/qemu_mym/bin/qemu-system-i386   -hda  ../lubuntu/lubuntu12.04.raw   -boot c  -m 1024  -rtc clock=vm -icount shift=4,align=off -d in_asm,exec -D /mnt/freenas-intel/log.log
